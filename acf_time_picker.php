...
* Plugin URI:  http://www.advancedcustomfields.com/add-ons/date-time-picker/
* Description: Adds an Date and Time Picker Field to Advanced Custom Fields. Pick and choose the components and layout of the Date and Time Picker.
* Author:      Per Søderlind. Converted to a WordPress plugin by Stephen Mullen
* Author URI:  
* Version:     1.2.0
* Text Domain: acf_time_picker
...
class acf_time_picker extends acf_Field
{
	...
	*-------------------------------------------------------------------------------------*/
	...
	function admin_print_scripts()
	{
		...
		wp_enqueue_script('jquery-ui-timepicker', plugins_url('js/jquery-ui-timepicker-addon.js', __FILE__ ),array(
			'jquery-ui-datepicker',
			'jquery-ui-slider'
		),'1.0.0', true ); 	
		wp_enqueue_script('timepicker', plugins_url('js/timepicker.js', __FILE__),array(
	...
	function admin_print_styles()
	{
		...
		wp_enqueue_style('timepicker',  plugins_url('/css/jquery-ui-timepicker-addon.css', __FILE__ ),array(
			'jquery-style'
		),'1.0.0');
	}
...
endif; //class_exists 'ACF_Time_Picker'

if( !class_exists( 'ACF_Time_Picker_Helper' ) ) :

/**
 * Advanced Custom Fields - Address Field Helper
 * 
 * This class is a Helper for the ACF_Time_Picker class.
 * 
 */
class ACF_Time_Picker_Helper {
	/**
	...
	* @var string
	*/
	const L10N_DOMAIN = 'acf_time_picker';
	
	/**
	 * Singleton instance
	 * @var ACF_Time_Picker_Helper
	 */
	private static $instance;
	
	/**
	 * Returns the ACF_Time_Picker_Helper singleton
	 * 
	 * <code>$obj = ACF_Time_Picker_Helper::singleton();</code>
	 * @return ACF_Time_Picker_Helper
	 */
	...
	/**
	 * Prevent cloning of the ACF_Time_Picker_Helper object
	 * @internal
	 */
	...
	private function __construct() {
		...
		add_action( 'init', array( &$this, 'register_acf_time_picker_field' ), 5, 0 );
	 ...
	 */
	public function register_acf_time_picker_field() {
		if( function_exists( 'register_field' ) ) {
			register_field( 'acf_time_picker', __FILE__ );
		}
	}
...
endif; //class_exists 'ACF_Time_Picker_Helper'

//Instantiate the Addon Helper class
ACF_Time_Picker_Helper::singleton();
